...
def build_mat(mf6, sln):
    ...
    NCOL = mf6.get_value(mf6.get_var_address("NCOL", sln))
    NROW = mf6.get_value(mf6.get_var_address("NROW", sln))
    ...
    A = mf6.get_value(mf6.get_var_address("AMAT", sln))
    IA = mf6.get_value(mf6.get_var_address("IA", sln))
    JA = mf6.get_value(mf6.get_var_address("JA", sln))
...
max_iter = mf6.get_value(mf6.get_var_address("MXITER", sln))
...
while current_time < end_time:
    ...
    A, ASLN, _, _ = build_mat(mf6, sln)
    RHS = mf6.get_value(mf6.get_var_address("RHS", sln))
    print("\nA:\n", A)
    print(linea)
    print("\nAMAT:\n", ASLN)
    print(linea)
...
SOL_MF6 = np.copy(mf6.get_value_ptr(mf6.get_var_address("X", 'TRANS')))
